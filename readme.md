...
- [Modern JavaScript cheatsheet](#modern-javascript-cheatsheet)
  ...
  * [概念](#概念)
    ...
    + [函式預設參數](#函式預設參數)
      - [外部資源](#外部資源-1)
    + [解構賦值 物件和陣列](#解構賦值 物件和陣列)
      - [示例代碼說明](#示例代碼說明)
      - [有用的資源](#有用的資源-1)
    + [陣列方法 - map / filter / reduce](#陣列方法---map--filter--reduce)
      - [示例代碼](#示例代碼-2)
      - [說明](#說明)
 ...
    + [物件屬性簡寫](#物件屬性簡寫)
    ...
    + [Promises](#promises)
      - [示例代碼](#示例代碼-4)
      - [說明](#說明-3)
        * [創建 promise](#創建 promise)
        * [Promise 處理器運用](#promise-處理器運用)
      - [外部資源](#外部資源)
    + [模板字面量](#模板字面量)
      - [示例代碼](#示例代碼-5)
      - [外部資源](#外部資源-2)
    ...
    + [Imports / Exports](#imports--exports)
      - [示例代碼說明](#示例代碼說明-1)
        * [命名 exports](#命名-exports)
        * [預設 import / export](#預設-import--export)
      - [外部資源](#外部資源-3)
