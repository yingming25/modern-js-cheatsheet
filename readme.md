...
- [Modern JavaScript cheatsheet](#modern-javascript-cheatsheet)
 ...
    + [解構賦值 物件與陣列](#destructuring-objects-and-arrays)
      - [示例說明](#explanation-with-sample-code)
 ...
    + [物件屬性簡寫](#object-property-shorthand)
      - [說明](#explanation-2)
      - [外部資源](#external-resources-1)
    ...
    + [Async Await](#async-await)
      ...
      - [示例代碼](#explanation-with-sample-code-2)
...
<a name="destructuring-objects-and-arrays"></a>
### 解構賦值物件與陣列
